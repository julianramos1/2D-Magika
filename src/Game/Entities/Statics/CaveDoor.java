...
public class CaveDoor extends Door {
	...
	public CaveDoor(Handler handler, float x, float y,BaseWorld world) {
		super(handler, x, y, world);
		this.world=world;
		health=10000000;
		bounds.x=0;
		bounds.y=0;
	...
	public void render(Graphics g) {
		for (Item i : handler.getWorld().getEntityManager().getChest().getCaveChestInventory().getInventoryItems()) {
